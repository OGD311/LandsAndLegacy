...
{   
    public static int[,] GenerateCaves(int[,] map, int MapWidth)
    {
        ...
        int NumCaves = (int)(MapWidth / (int)(Random.Range(66, 125)/10)); //Number of caves to generate based on world size (more caves the bigger the world)
        for (int c = 0; c < NumCaves; c++) 
        {
